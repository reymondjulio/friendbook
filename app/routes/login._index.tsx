  ...
  return (
    <div className="container mx-auto w-full max-w-6xl p-4 gap-x-6 gap-y-12 flex flex-wrap justify-center lg:justify-between lg:items-center min-h-screen">
      <div className="max-w-lg w-full space-y-4 text-center lg:text-left self-center lg:mb-44">
        <h1 className="text-4xl lg:text-6xl text-blue-500 font-bold">
          Friendbook
        </h1>
      ...
      <div className="max-w-sm w-full ring-0 mb-24">
        <Form method="POST" className="flex flex-col gap-y-4 bg-white p-6">
        ...
        <div>
          ...
          <Link
            to="/register"
            className="bg-green-500 hover:bg-green-400 py-2 rounded text-white text-sm font-bold w-full text-center self-center"
          >
            Create New Account
          </Link>
        </div>
